...
public class DatabaseContactRepository implements ContactRepository{
    ...
    public Contact save(Contact contact) {
        log.debug("calling DatabaseContactRepository -> save contact: {}", contact);
    ...
    public Contact update(Contact contact) {
        log.debug("calling DatabaseContactRepository -> update task with task: {}", contact);
        ...
        throw new ContactNotFoundException("Contact for update not found! ID: " + contact.getFirstName());

    }

    @Override
    public void deleteById(Long id) {
        log.debug("calling DatabaseContactRepository -> delete contact with ID: {}", id);
